<template>
  ...
  export default {
    data() {
      return {
        ...
        specialtiesList: [
          { 
            name: "Cardiologie", 
            subSpecialtiesList: ["Cardiologie pédiatrique", "Rythmologie", "Chirurgie cardiaque"]
          },
          { 
            name: "Neurologie", 
            subSpecialtiesList: ["Neurochirurgie", "Neurologie pédiatrique", "Épileptologie"]
          },
          { 
            name: "Chirurgie générale", 
            subSpecialtiesList: ["Chirurgie digestive", "Chirurgie bariatrique"]
          },
          { 
            name: "Oncologie", 
            subSpecialtiesList: ["Oncologie pédiatrique", "Radiothérapie", "Hémato-oncologie"]
          },
          { 
            name: "Pédiatrie", 
            subSpecialtiesList: ["Néonatologie", "Pneumologie pédiatrique"]
          },
          { 
            name: "Radiologie", 
            subSpecialtiesList: ["Imagerie médicale", "Radiologie interventionnelle"]
          },
          { 
            name: "Médecine d'urgence", 
            subSpecialtiesList: ["Urgences pédiatriques", "Réanimation"]
          }
        ]
      };
    },
    methods: {
      handleSubmit() {
        if (this.hospital.specialties.length === 0) {
          alert("Veuillez ajouter au moins une spécialité.");
          return;
        }
