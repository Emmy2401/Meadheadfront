<template>
  ...
  export default {
    ...
    created() {
      // ✅ Simulation de récupération d'un hôpital existant avec spécialités & sous-spécialités
      this.hospital = {
        id: this.id,
        ...
        numberOfBeds: 150,
        specialties: [
          { name: "Cardiologie", subSpecialties: ["Rythmologie", "Chirurgie cardiaque"], subSpecialtiesList: ["Cardiologie pédiatrique", "Rythmologie", "Chirurgie cardiaque"] },
          { name: "Neurologie", subSpecialties: ["Neurochirurgie"], subSpecialtiesList: ["Neurochirurgie", "Neurologie pédiatrique", "Épileptologie"] }
        ]
      };
    },
    methods: {
